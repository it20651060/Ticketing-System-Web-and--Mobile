...
const AllPassengers = () => {
  ...
  useEffect(() => {
    function passengers() {
      axios
        .get(`http://localhost:8070/passengers/search/?q=${query}`)
        .then((res) => {
  ...
  const deletePassenger = (id) => {
    axios
      .delete(`http://localhost:8070/passengers/delete/${id}`)
      .then((res) => {
        axios
          .get("http://localhost:8070/passengers/")
          .then((res) => {
      ...
      <section class="ad-dashboard">
        <div>
          <div class="ad-top">
            ...
            <button type="submit" class="ad-search-box-button">
              Search
            </button>
                        ...
                        <td>
                          <span class="data-list">
                            <button className="button-accept">
                              <a
                                className="button-accept-a"
                                title=""
                                href={`/passengersedit/${passenger._id}`}
                              >
                                Edit
                              </a>
                            </button>
